package com.abhi.spring.jdbc.postgresql.controller;

import java.util.ArrayList;
import java.util.List;

import com.abhi.spring.jdbc.postgresql.model.Tutorial;
import com.abhi.spring.jdbc.postgresql.repository.TutorialRepository;
...
public class TutorialController {
  ...
  public ResponseEntity<String> createTutorial(@RequestBody Tutorial tutorial) {
    try {
      tutorialRepository.save(new Tutorial(tutorial.getTitle(), tutorial.getDescription(), tutorial.isPublished()));
